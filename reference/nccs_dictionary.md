...
#>    <chr>                       <chr>                                       <chr>
#>  1 accounting_period           Month when organizations accounting period… char…
#>  2 activity_code               Three 3-digit activity codes concatenated … char…
...
#>  5 affiliation_code            Code indicating relationship to parent org… char…
...
#>  8 asset_amount                Total assets in dollars (most recent retur… char…
#>  9 asset_code                  Asset amount range code (0-9)               char…
...
#>  5 geo_distance     Distance in meters between input address and matched … char…
...
#> 13 geo_postal       ZIP code resolved by geocoder for cross-referencing w… char…
#> 14 geo_postal_ext   ZIP+4 extension resolved by geocoder                   char…
#> 15 geo_score        Geocoder match confidence score (1-100)                char…
#> 16 geo_state        State name from geocoder                               char…
#> 17 geo_state_abbr   State abbreviation from geocoder                       char…
#> 18 geo_status       Geocoder match status (M=Match T=Tied U=Unmatched)     char…
...
#>    column_name                 description                                 type 
#>    <chr>                       <chr>                                       <chr>
#>  1 ntee_code_clean             Standardized 3-character NTEE code. UNDEFI… char…
#>  2 ntee_code_definition        Full description of NTEE classification. U… char…
...
#> 11 nteev2_subsector_definition Human-readable NTEEv2 subsector name (e.g.… char…
```
